...
router.get('/sell', async (req, res) => {
  ...
  if (sellerID) {
    ...
    sql = `SELECT SellingID, Name as SellerName, PhoneNumber, BookID, SellerID, Price, SellingTime FROM Student as std \
                  inner join (SELECT * FROM SELLING WHERE BookID=${parseInt(bookID)}) as b where std.StudentID = b.SellerID ORDER BY Price`;
  }
  else {
